...
public class RefreshableView extends LinearLayout implements OnTouchListener,
	...
	private boolean load = false, needLoad = false, needrefresh = true;
	 ...
	 * 刷新时显示的进度条
	 */
	private ProgressBar progressBar, loadProgressBar;
	...
	public RefreshableView(Context context, AttributeSet attrs) {
		...
		header = mInflater.inflate(R.layout.pull_to_refresh, null, true);
		footer = mInflater.inflate(R.layout.pull_to_load, null, true);
		button = (Button) footer.findViewById(R.id.load);
		loadProgressBar = (ProgressBar) footer
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if ((lastItem + 1) == totalItemCount && !load
				&& needLoad ) {
			load = true;
	...
	public void onClick(View v) {
		if (v.getId() == R.id.load && mLoadListener != null) {
			load(true);
			new Thread(new Runnable() {
