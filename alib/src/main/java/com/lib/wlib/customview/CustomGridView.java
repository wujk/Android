...
import com.lib.wlib.viewhelper.attrbuset.GridViewAttrbuteSet;


public class CustomGridView extends FrameLayout implements CustomView{
	private GridViewAttrbuteSet attrbuteSet = new GridViewAttrbuteSet();
	...
	public void initView(Context context) {
		...
		gridview = (GridView) view.findViewById(R.id.custom_gridview);
